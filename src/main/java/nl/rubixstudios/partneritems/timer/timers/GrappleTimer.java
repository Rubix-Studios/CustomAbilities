...
/**
 * @author Djorr
 * @created 20/11/2022 - 02:14
 * @project PartnerItems
 */
public class GrappleTimer extends PlayerTimer implements ScoreboardTimer {
    String placeholder = " " + Config.PARTNER_ITEM_GRAPPLE_HARPOON_DISPLAY_NAME + "&7: &f";

    public GrappleTimer(ScheduledExecutorService executor) {
        super(executor, "GrappleTimer", Config.PARTNER_ITEM_GRAPPLE_HARPOON_COOLDOWN);
        this.setFormat(StringUtils.FormatType.MILLIS_TO_SECONDS);
        this.setExpiryMessage(ColorUtil.translate(Config.PARTNER_ITEM_GRAPPLE_HARPOON_DISPLAY_NAME + " &8»") + Color.translate("&7 Your cooldown has been expired!"));
    }
