 ...
 */
public class ParalyzedHoeTimer extends PlayerTimer implements ScoreboardTimer {
    String placeholder = " " + Config.PARTNER_ITEM_PARALYZED_HOE_DISPLAY_NAME + "&7: &f";

    public ParalyzedHoeTimer(ScheduledExecutorService executor) {
        super(executor, "ParalyzedHoeTimer", Config.PARTNER_ITEM_PARALYZED_HOE_COOLDOWN);
        this.setFormat(StringUtils.FormatType.MILLIS_TO_SECONDS);
        this.setExpiryMessage(ColorUtil.translate(Config.PARTNER_ITEM_PARALYZED_HOE_DISPLAY_NAME + " &8»") + Color.translate("&7 Your cooldown has been expired!"));
    }
