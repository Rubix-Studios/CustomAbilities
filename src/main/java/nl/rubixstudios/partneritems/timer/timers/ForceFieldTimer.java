 ...
 */
public class ForceFieldTimer extends PlayerTimer implements ScoreboardTimer {
    String placeholder = " " + Config.PARTNER_ITEM_FORCE_FIELD_DISPLAY_NAME + "&7: &f";

    public ForceFieldTimer(ScheduledExecutorService executor) {
        super(executor, "ForceFieldTimer", Config.PARTNER_ITEM_FORCE_FIELD_COOLDOWN);
        this.setFormat(StringUtils.FormatType.MILLIS_TO_SECONDS);
        this.setExpiryMessage(ColorUtil.translate(Config.PARTNER_ITEM_FORCE_FIELD_DISPLAY_NAME + " &8»") + Color.translate("&7 Your cooldown has been expired!"));
    }
